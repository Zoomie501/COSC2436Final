...
Student: Enrique Morell Course: COSC 2436 Fall 23
...
Array List: A Dynamic Array is used to store the entire collection, allowing for efficient addition and removal of records from the collection, as well as the ability to access any record in the collection directly by its name.
Linear Search: The key for the linear search is the genre, and the value is the record itself.
Algorithms:
